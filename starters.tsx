  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.sub}>
        Total starters: <Text style={styles.count}>{items.length}</Text>
      </Text>

      <Text style={styles.avg}>Average price (Starters): R{avgStarters.toFixed(2)}</Text>
      ...
      <FlatList
        ...
        ListEmptyComponent={<Text style={styles.emptyText}>No starters yet.</Text>}
